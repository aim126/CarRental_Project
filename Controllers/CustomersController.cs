...
namespace CarRentalProject.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,Address,City,State,ZipCode,EmailAddress,CarType,CarLocation,CarPickupDate,CarReturnDate,CarReturnLocation,IdentityUserId")] Customer customer)
        {
